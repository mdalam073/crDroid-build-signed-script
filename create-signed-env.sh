...
mkdir vendor/voltage-priv
mv ~/.android-certs vendor/voltage-priv/keys
echo "PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/voltage-priv/keys/releasekey" > vendor/voltage-priv/keys/keys.mk
cat <<EOF > vendor/voltage-priv/keys/BUILD.bazel
filegroup(
...
echo "Done! Now build as usual. If builds aren't being signed, add '-include vendor/voltage-priv/keys/keys.mk' to your device mk file"
echo "Make copies of your vendor/voltage-priv folder as it contains your keys!"
sleep 3
